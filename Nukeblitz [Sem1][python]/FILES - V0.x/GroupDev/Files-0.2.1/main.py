...
def sound():
    if soundv:
        ...
        ws.PlaySound("theme.wav",ws.SND_ALIAS|ws.SND_NODEFAULT|ws.SND_ASYNC)
...
def killsav():
    ...
    try:
        ...
        pass
    delf=tk.Tk()
    delf.wm_title("Saves deleted.!")
    delf.iconbitmap("icon.ico")
    delf.geometry("225x125+513+231")
    delfmes=tk.Message(delf,text="Save file deleted.")
...
def homeopt():
    ...
    homeop.geometry("300x175+500+200")
